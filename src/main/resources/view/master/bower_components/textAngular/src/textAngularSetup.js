...
angular.module('textAngularSetup', [])
    ...
    .run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', function (taRegisterTool, $window, taTranslations, taSelection) {
        ...
        var buttonName = ['large', 'middle', 'small'];
        var buttonNameCount = 0;
        angular.forEach(['h1', 'h3', 'h5'], function (h) {
            taRegisterTool(h.toLowerCase(), {
                buttontext: buttonName[buttonNameCount].toUpperCase(),
